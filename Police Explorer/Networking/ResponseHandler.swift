...
typealias NetworkValidationResult = Result<(Data, HTTPURLResponse), NetworkError>
...
extension ResponseHandler {
    ...
    static func isValidResponseStatus(_ response: HTTPURLResponse) -> Bool {
    ...
    static func isRateLimitedResponse(_ response: HTTPURLResponse) -> Bool {
    ...
    static func isUnauthorized(_ response: HTTPURLResponse) -> Bool {
    ...
    static func validateResponse(data: Data?, response: URLResponse?, error: Error?) -> NetworkValidationResult {
